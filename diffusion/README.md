# Koopman Autoencoders for Video Diffusion

This project explores whether **Koopman Autoencoders (KAE)** can improve video diffusion models by learning linear dynamics in latent space.
